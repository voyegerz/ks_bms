				...
				<table class="table" id="manageProductTable">
					<thead>
						<tr>
							...
							<th>Category</th>
							<th>Status</th>
							<th style="width:5%;">Manage Stock</th>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
			...
			<div class="form-group">
				<label for="hsn" class="col-sm-3 control-label">HSN</label>
				<label class="col-sm-1 control-label">: </label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="hsn" placeholder="HSN" name="hsn" autocomplete="off">
				</div>
			</div>
			...
			<div class="form-group">
				<label for="manageStock" class="col-sm-3 control-label">Manage Stock</label>
				<label class="col-sm-1 control-label">: </label>
				<div class="col-sm-8">
				<select class="form-control" id="manageStock" name="manageStock">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
						...
						<div class="form-group">
							<label for="editHsn" class="col-sm-3 control-label">HSN</label>
							<label class="col-sm-1 control-label">: </label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="editHsn" placeholder="HSN" name="editHsn" autocomplete="off">
							</div>
						</div>
					...
					<div class="form-group">
						<label for="editManageStock" class="col-sm-3 control-label">Manage Stock: </label>
						<label class="col-sm-1 control-label">: </label>
						<div class="col-sm-8">
							<select class="form-control" id="editManageStock" name="editManageStock">
